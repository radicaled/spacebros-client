...
var connection_established_receiver = null
var connection_established_receiver_f = null
...
func _run(_self):
	...
	dispatcher.emit_signal(CONNECTION_ESTABLISHED)
...
func set_connection_established_reciever(o, f):
	connection_established_receiver = o
	connection_established_receiver_f = f
	dispatcher.connect(CONNECTION_ESTABLISHED, connection_established_receiver, connection_established_receiver_f)

	
func _init(reference).():
	dispatcher.add_user_signal(MESSAGE_RECIEVED)
	dispatcher.add_user_signal(BINARY_RECIEVED)
	dispatcher.add_user_signal(CONNECTION_ESTABLISHED)
